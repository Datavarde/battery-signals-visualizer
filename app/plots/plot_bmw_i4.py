import pandas as pd
from app.dtos.bmw_i4 import BMW_I4_PLOT_SIGNALS
...
BMW_I4_Battery_Capacity_BOL = 84  # kWh
...
def append_estimated_signals_for_bmw_i4(
    *, df_with_physical_signals: pd.DataFrame
    ...
    df_with_estimated_and_physical_signals["estimated_soh"] = (
        df_with_physical_signals["max_energy_capacity"] / BMW_I4_Battery_Capacity_BOL
    ) * 100
    ...
    df_with_estimated_and_physical_signals["estimated_soh"] = (
        df_with_estimated_and_physical_signals["estimated_max_energy_capacity"]
        / BMW_I4_Battery_Capacity_BOL
    ) * 100
    return df_with_estimated_and_physical_signals


def build_dashboard_for_bmw_i4(
    *, df_with_estimated_and_physical_signals: pd.DataFrame, log_name: str
    ...
    cols = [ps.df_column for ps in BMW_I4_PLOT_SIGNALS]
    ...
    fig, trace_index, ranges = create_traces_for_signals(
        ...
        signals_to_plot=BMW_I4_PLOT_SIGNALS,
    )
    ...
    for plot_signal in BMW_I4_PLOT_SIGNALS:
                ...
                args=[
                    ...
                    },
                    {
                        **set_axes_visibility_for_the_selected_signals(
                            plot_signal_keys={plot_signal.key},
                            trace_index=trace_index,
                            plot_signals=BMW_I4_PLOT_SIGNALS,
                            axis_defs=axis_defs,
                        ),
                        (
